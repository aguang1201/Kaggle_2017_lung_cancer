...
model = tflearn.DNN(network, checkpoint_path=model_file,best_checkpoint_path=best_model_file,max_checkpoints=2, tensorboard_verbose=2,tensorboard_dir="./logs")

if os.path.isfile(best_model_file + ".index"):
    model.load(best_model_file)
    print('load the best modle:' + best_model_file)
